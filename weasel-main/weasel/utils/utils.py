...
def to_dict(obj: Optional[Union[dict, SimpleNamespace]]):
    if obj is None:
        ...
        return vars(obj)  # SimpleNamespace does have a __dict__ attribute
    else:
        try:
            return vars(obj)  # This works for class instances with __dict__
        except TypeError:
            return obj  # Return the object as-is if it doesn't have __dict__
